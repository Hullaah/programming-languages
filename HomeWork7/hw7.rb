  ...
  def intersectWithSegmentAsLineResult seg
    ...
    if real_close(x1start, x1end)
      ...
      if y1start < y2start
        ...
        aXstart, aYstart, aXend, aYend = x2start, y2start, x2end, y2end
        bXstart, bYstart, bXend, bYend = x1start, y1start, x1end, y1end
      end
